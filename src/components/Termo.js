import FooterHome from '../sections/footer/FooterHome';
const Termo = () => {
  return (
    <div>
      <div className="row mx-5 my-2">
        <img src="../../img/jpw.png" className="col-lg-4 col-md-6 col-sm-8 mx-auto mb-4" />
        <h2 className="mb-3">
          <strong>Termos e condições de uso do site ou blog</strong>
        </h2>
        <p className="mb-4">
          Seja bem-vindo ao nosso site. Leia com muita atenção todos os termos
          abaixo.
        </p>
        <p h2 className="mb-2">
          Este documento, e todo o conteúdo do site é oferecido por{" "}
          <strong>JPW Ferragens</strong>, neste termo representado apenas por
          "EMPRESA", que regulamenta todos os direitos e obrigações com todos que
          acessam o site, denominado neste termo como "VISITANTE", reguardado
          todos os direitos previstos na legislação, trazem as cláusulas abaixo
        ...
        <h3 className="my-3">
          <strong>1. DA FUNÇÃO DO SITE</strong>
        </h3>
        <p className="mb-2">
          ...
          divulgação de prestação de serviço. A EMPRESA busca através da criação
          de conteúdo de alta qualidade, desenvolvido por profissionais da área,
          trazer o conhecimento ao alcance de todos, assim como a divulgação dos
          próprios serviços.
        </p>
        <p className="mb-2">
        ...
        <p className="mb-2">
          ...
          atual, não podendo a EMPRESA ser responsabilizada de nenhuma forma ou
          meio por qualquer conteúdo que não esteja devidamente atualizado.
        </p>
        <p className="mb-4">
          É de responsabilidade do usuário de usar todas as informações presentes
          no site com senso crítico, utilizando apenas como fonte de informação, e
          sempre buscando especialistas da área para a solução concreta do seu
          conflito.
        </p>
        <h3 className="my-3">
          2. <strong>DO ACEITE DOS TERMOS</strong>
        </h3>
        <p className="mb-2">
          Este documento, chamado "Termos de Uso", aplicáveis a todos os
          visitantes do site, foi desenvolvido por{" "}
          <a href="https://diegocastro.adv.br/">Diego Castro</a> Advogado - OAB/PI
          15.613, modificado com permissão para este site.
        </p>
        <p className="mb-2">
          ...
          estabelece entre a EMPRESA e o VISITANTE direitos e obrigações entre
          ambas as partes, aceitos expressamente pelo VISITANTE a permanecer
          navegando no site da EMPRESA.
        </p>
        <p className="mb-2">
          Ao continuar acessando o site, o VISITANTE expressa que aceita e entende
          todas as cláusulas, assim como concorda integralmente com cada uma
          delas, sendo este aceite imprescindível para a permanência na mesma.
          Caso o VISITANTE discorde de alguma cláusula ou termo deste contrato, o
          mesmo deve imediatamente interromper sua navegação de todas as formas e
          meios.
        </p>
        <p className="mb-2">
        ...
        <ul className="mx-2">
          <li className="mb-2">
            <strong>VISITANTE: </strong>Todo e qualquer usuário do site, de
            qualquer forma e meio, que acesse através de computador, notebook,
            tablet, celular ou quaisquer outros meios, o website ou plataforma da
            empresa.
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            <strong>COOKIES:</strong> Pequenos arquivos de textos gerados
            automaticamente pelo site e transmitido para o navegador do visitante,
            que servem para melhorar a usabilidade do visitante.
          </li>
          <li className="mb-2">
            <strong>LOGIN:</strong> Dados de acesso do visitante ao realizar o
            cadastro junto a EMPRESA, dividido entre usuário e senha, que dá
            acesso a funções restritas do site.
          </li>
          <li className="mb-2">
            <strong>HIPERLINKS: </strong>São links clicáveis que podem aparecer
            pelo site ou no conteúdo, que levam para outra página da EMPRESA ou
            site externo.
          </li>
          <li className="mb-2">
            <strong>OFFLINE:</strong> Quando o site ou plataforma se encontra
        ...
        <p className="mb-2">
          ...
          VISITANTE deverá entrar em contato com a EMPRESA através dos canais de
          comunicação encontradas no site.
        </p>

        <h3 className="my-3">
          4<strong>. DO ACESSO AO SITE</strong>
        </h3>
        <p className="mb-2">
        ...
        <p className="mb-2">
          A EMPRESA não se responsabiliza por nenhuma perda de oportunidade ou
          prejuízos que esta indisponibilidade temporária possa gerar aos
          usuários.
        </p>
        <p className="mb-2">
        ...
        <h3 className="my-3">
          <strong>5. DA LICENÇA DE USO E CÓPIA</strong>
        </h3>
        <p className="mb-2">
        ...
        <p className="mb-2">
          ...
          ), assim como no Código Civil brasileiro (regulamentada na{" "}
        ...
        <p className="mb-2">
          ...
          permitindo a cópia ou utilização de nenhuma forma e meio, sem
          autorização expressa e por escrita da mesma.
        </p>
        <p className="mb-2">
          A EMPRESA poderá em casos concretos permitir pontualmente exceções a
          este direito, que serão claramente destacados no mesmo, com a forma e
          permissão de uso do conteúdo protegido. Este direito é revogável e
          limitado as especificações de cada caso.
        </p>

        <h3 className="my-3">
          6.<strong> DAS OBRIGAÇÕES</strong>
        </h3>
        <p className="mb-2">
        ...
        <ul className="mx-2">
          ...
          <li className="mb-2">
            ...
            discussão daquele texto, vídeo ou imagem.
          </li>
          <li className="mb-2">
          ...
          <li className="mb-2">
            ...
            forma, requerer a exclusão dos mesmos, através do formulário de
            contato.
          </li>
        </ul>

        <h3 className="my-3">
          <strong>7. DA MONETIZAÇÃO E PUBLICIDADE</strong>
        </h3>
        <p className="mb-2">
          ...
          <a href="https://www.google.com/">Google</a>), Taboola ou outras
          plataformas especializadas como o{" "}
          <a href="https://eletrocriticas.com/">Eletro Críticas.</a>
        </p>
        <p className="mb-2">
          ...
          compras, visitas, acessos ou quaisquer ações referentes as estas
          empresas.
        </p>
        <p className="mb-2">
        ...
        <p className="mb-2">
          ...
          até 07 (sete) dias, conforme o Código de Defesa do Consumidor.
        </p>
        <p className="mb-2">
        ...
        <h3 className="my-3">
          8. <strong>DOS TERMOS GERAIS</strong>
        </h3>
        <p className="mb-2">
        ...
        <p className="mb-5">Este Termo de uso é valido a partir de 06 de Julho de 2022.</p>
      </div>
      <FooterHome />
    </div>
  );
